    ...
    <div className="chat-widget-wrapper">
        ...
        <div className="chat-container">
          ...
          <form className="input-area" onSubmit={handleSend}>
            ...
            <div className="footer-note">
              <span style={{fontFamily: 'Bricolage Grotesque'}}>Ask me about programming, web dev, or tech!</span>
      ...
      {!isOpen && (
        <button className="chat-trigger-btn" onClick={() => setIsOpen(true)}>
          ...
          <span style={{fontFamily: 'Bricolage Grotesque'}}>Chat with Robert</span>
        </button>
      )}
    </div>
  );
